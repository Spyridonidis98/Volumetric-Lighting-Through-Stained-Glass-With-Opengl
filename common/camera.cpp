...
Camera::Camera(GLFWwindow* window) : window(window) {
    position = vec3(9, 5.7, 1.28);
    horizontalAngle = 5.45f;
    verticalAngle = -0.29f;
    FoV = 45.0f;
    speed = 3.0f;
    mouseSpeed = 0.001f;
    fovSpeed = 2.0f;
    //hor = 5.176009 ver =-0.229000 pos= 15.826406 6.315897 0.097394
    //hor = 5.457993 ver =-0.284000 pos= 14.770714 8.313313 -5.419585
    //hor = 5.373999 ver =-0.229000 pos= 9.000005 5.676928 1.286275
}
...
void Camera::update() {
    ...
    //*/
    //printf(" hor = %f ver =%f pos= %f %f %f\n", horizontalAngle, verticalAngle, position.x, position.y, position.z);
